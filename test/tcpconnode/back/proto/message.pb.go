...
func (m *MessageReq) GetSerialNumber() int64 {
	if m != nil {
...
func (m *MessageResp) GetSerialNumber() int64 {
	if m != nil {
		return m.SerialNumber
	}
	return 0
...
var fileDescriptor_33c57e4bae7b9afd = []byte{
	...
	,
}
...
func (m *MessageReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SerialNumber != 0 {
		i = encodeVarintMessage(dAtA, i, uint64(m.SerialNumber))
		i--
		dAtA[i] = 0x8
	}
...
func (m *MessageReq) Size() (n int) {
	...
	_ = l
	if m.SerialNumber != 0 {
		n += 1 + sovMessage(uint64(m.SerialNumber))
	}
	if m.RpcId != 0 {
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SerialNumber |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
